      ...
      <Grid container spacing={3}>
        <Grid item xs={12} sm={6} md={3}>
          <Card variant="outlined"><CardContent sx={{ textAlign: 'center', py: 3 }}>
            <Box display="flex" justifyContent="center" mb={1} color="primary.main"><GroupIcon fontSize="large" /></Box>
            <Typography variant="h3" fontWeight={700} color="primary">{data?.teamSize ?? '—'}</Typography>
            <Typography variant="subtitle2" color="text.secondary" mt={0.5}>Team Size</Typography>
          </CardContent></Card>
        </Grid>
        <Grid item xs={12} sm={6} md={3}>
          <Card variant="outlined" sx={{ borderColor: pendingCount > 0 ? 'warning.main' : undefined }}>
            <CardActionArea onClick={() => navigate('/approvals')}>
              <CardContent sx={{ textAlign: 'center', py: 3 }}>
                <Box display="flex" justifyContent="center" mb={1} color="warning.main"><PendingActionsIcon fontSize="large" /></Box>
                <Typography variant="h3" fontWeight={700} color="warning.main">{pendingCount}</Typography>
                <Typography variant="subtitle2" color="text.secondary" mt={0.5}>Pending Approvals</Typography>
                <Button size="small" variant="outlined" sx={{ mt: 1.5 }}>Review All</Button>
              </CardContent>
            </CardActionArea>
          </Card>
        </Grid>
        <Grid item xs={12}>
          <Card variant="outlined"><CardContent>
            <Typography variant="h6" mb={2}>Team Pending Requests</Typography>
