...
public class HolidayEntityTests
{
    ...
    public void Holiday_Year_MatchesDateYear()
    {
        ...
        var holiday = new Holiday { Name = "Independence Day", Date = date, Year = date.Year };
    ...
    {
        var holiday = new Holiday { Name = "Company Founder Day 2026", Date = new DateOnly(2026, 6, 1), Year = 2026, IsRecurring = false };
        Assert.False(holiday.IsRecurring);
    }
    ...
    {
        var holiday = new Holiday { Name = "Diwali", Date = new DateOnly(2026, 10, 20), Year = 2026, IsRecurring = true };
        Assert.True(holiday.IsRecurring);
    }
}
